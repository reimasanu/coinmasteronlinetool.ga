var X00Gems = ['100,000', '200,000', '400,000', '500,000', '800,000', '999,999'];
var X00Processes = [
...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;">' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="label label-default" style="font-weight: bold;">has generated</span> <span class="label label-success" style="font-weight: bold;">' + X00Gems[X00Random(0, X00Gems.length)] + ' Coins & Spins </span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
